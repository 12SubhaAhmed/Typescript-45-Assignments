...
let Friends : string []= ["Rameen","Aisha","Muskan"];
...
let Guests : string [] = ["Hisba","Araib","Azhan","Kainat"]
let notcoming : string = "Araib"
...
///////////TASK 18
let places :string[] = ["India","China","America","Turkey","Saudia"];
...
let invitations : string[] = ["Rameen","Hisba"];
let invitations_count : number = invitations.length
...
let name_1 : string = "Azhan"
let name_2 : string = "Araib"
let name_3 : string = "Hisba"
...
let country : string[] = ["Pakistan","India","japan"]
...
let favorite_fruits : string[] = ["Apple","orange","Mango","melon","peach"]
...
let users : string[] = ["Admin","Eric","Nick","Harry","George"];
...
let username : string[] = ["Admin","Harry","Nick","Eric","George"];
...
let current_users : string[] = ["Admin","Eric","Hamza","Araib","Azhan"]
let new_users : string[] = ["Admin","Araib","Arham","Zubair","Hadi"]
...
let pizza : string[]=["Chicken","Pepperoni","Veg"]
...
const magician : string[] = ["ali","hamza","asim"]
...
const magicians2 : string[] = ["ali","hamza","asim"];
...
const magician3 : string[] = ["araib","azhan","hassan"]
...
function sandwitches(...items : string[]) : void{
...
function createCar(manufacturer : string, model : string , optional : Record<string,any>): cars {
     return{
        manufacturer,
        model,
        ...optional
...
const my_car : cars = createCar("Toyota","Corolla",{color : 'silver', year : '2024'})
console.log(my_car);